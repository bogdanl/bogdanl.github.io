var FBO = function( exports ){
    ...
    exports.init = function( width, height, renderer, simulationMaterial, renderMaterial ){
        ...
        for ( var i = 0; i < l; i++ ) {
            ...
            // var hue = Math.random() * 10 + 110;
            // var lightness = Math.floor(Math.random() * Math.floor(50));;
            // color.set(`hsl(${hue}, 100%, ${lightness}%)`);
        ...
        geometry.addAttribute( 'newcolor',  new THREE.BufferAttribute( colors, 3 ) );
